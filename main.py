...
async def predict(body: ImageRequest):
    ...
    if img_original is None:
        raise HTTPException(status_code=400, detail="Imagen corrupta o ilegible")
    ...
    if crop is None:
        raise HTTPException(status_code=400, detail="No se detectó zona de interés (OP)")

    clOA, prOA, x1OA, y1OA, x2OA, y2OA = yolodetOA(modeldetOA, crop, certeza)
